...
public class EdibleEvent {
	...
	public static InteractionResult onClickEmpty(Player player, Level world, InteractionHand hand) {
		...
		if (item.equals(Items.BLAZE_POWDER)) {
			...
			MobEffectInstance effect = new MobEffectInstance(MobEffects.STRENGTH, ConfigHandler.blazePowderStrengthDurationSeconds*20);
			...
			MobEffectInstance effect = new MobEffectInstance(MobEffects.SPEED, ConfigHandler.sugarSpeedDurationSeconds*20);
			player.addEffect(effect);
		}
			...
			MobEffectInstance effect = new MobEffectInstance(MobEffects.JUMP_BOOST, ConfigHandler.rabbitsFootDurationSeconds*20);
			player.addEffect(effect);
		}
